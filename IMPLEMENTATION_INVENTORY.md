...
| `diffObj` | `crates/json-joy-core/src/diff_runtime/common.rs` (`try_emit_object_recursive_diff`) | approx | yes | yes | yes | yes | Two-pass delete/insert shape present; keep verifying op ordering and edge semantics. |
...
| `diffVec` | `crates/json-joy-core/src/diff_runtime/vec.rs` + `common.rs` | approx | yes | yes | yes | no | Parity tests pass; not yet isolated in perf ledger. |
