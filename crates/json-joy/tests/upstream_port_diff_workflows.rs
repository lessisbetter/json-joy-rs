...
const PATCH_DIFF_APPLY_XFAILS: &[&str] = &[
    "diff_root_number_to_number_v1",
    "diff_root_bool_to_bool_v1",
    "diff_root_obj_to_scalar_v1",
    "diff_root_scalar_to_obj_v1",
    "diff_noop_array_v1",
    "diff_string_replace_v1",
    "diff_array_append_v1",
    "diff_array_insert_mid_v1",
    "diff_array_delete_mid_v1",
    "diff_array_replace_elem_v1",
    "diff_nested_array_v1",
    "diff_nested_combo_v1",
    "diff_doc_update_title_v1",
    "diff_doc_update_body_and_score_v1",
    "diff_doc_tag_add_v1",
    "diff_doc_tag_remove_v1",
    "diff_array_object_insert_v1",
    "diff_array_object_update_v1",
    "diff_null_to_object_v1",
    "diff_object_to_null_v1",
];

const MODEL_DIFF_DST_KEYS_XFAILS: &[&str] = &[
    "model_diff_dst_keys_05_v1",
    "model_diff_dst_keys_06_v1",
    "model_diff_dst_keys_09_v1",
    "model_diff_dst_keys_14_v1",
    "model_diff_dst_keys_15_v1",
    "model_diff_dst_keys_25_mirror_v1",
    "model_diff_dst_keys_26_mirror_v1",
    "model_diff_dst_keys_29_mirror_v1",
    "model_diff_dst_keys_34_mirror_v1",
    "model_diff_dst_keys_35_mirror_v1",
    "model_diff_dst_keys_45_mirror2_v1",
    "model_diff_dst_keys_46_mirror2_v1",
    "model_diff_dst_keys_49_mirror2_v1",
    "model_diff_dst_keys_54_mirror2_v1",
    "model_diff_dst_keys_55_mirror2_v1",
    "model_diff_dst_keys_65_mirror3_v1",
    "model_diff_dst_keys_66_mirror3_v1",
    "model_diff_dst_keys_69_mirror3_v1",
    "model_diff_dst_keys_74_mirror3_v1",
    "model_diff_dst_keys_75_mirror3_v1",
];
